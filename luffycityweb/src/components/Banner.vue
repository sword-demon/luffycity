        ...
        <div class="g-banner pr" @mouseleave="state.current_menu = -1">
                ...
                <div class="inner-box">
                    ...
                    <div class="lore">
                        ...
                        <p class="lores clearfix">
                            <a target="_ blank" href="">Vue.js</a>
                            <a target="_blank" href="">Typescript</a>
                            <a target="_ blank" href="">React.JS</a>
                            <a target="_blank" href="">HTML/CSS</a>
                            <a target="_ blank" href="">JavaScript</a>
                            <a target="_blank" href="">Angular</a>
                            <a target="_ blank" href="">Node.js</a>
                            <a target="_blank" href="">jQuery</a>
                            <a target="_ blank" href="">Bootstrap</a>
                            <a target="_blank" href="">Sass/Less</a>
                            <a target="_ blank" href="">WebApp</a>
                            <a target="_blank" href="">小程序</a>
                            <a target="_ blank" href="">前端工具</a>
                            <a target="_blank" href="">CSS</a>
                            <a target="_ blank" href="">Html5</a>
                            <a target="_blank" href="">CSS3</a>
                        </p>
                    </div>
                </div>
                <div class="recomment clearfix">
                    <a href="" target="_ blank" title="" class="recomment-item">
                        <div
                            class="img"
                            style="
                                background-image: url('/src/assets/60a7779909e3fc1206960344.png');
                                background-size: 100%;
                            "
                        ></div>
                        <div class="details">
                            ...
                            <div class="title-box">
                                <p class="title">
                                    <span class="text">前端工程师2021</span>
                            ...
                            <div class="bottom">
                                ...
                                &middot;
                                <span class="num"
                                    ><i class="imv2-set-sns"></i> 19322</span
                                >
                            </div>
                        </div>
                    </a>
                    ...
                    >
                        <div
                            class="img"
                            style="
                                background-image: url('/src/assets/5e3cfea008e9a61b06000338-360-202.jpg');
                            "
                        ></div>
                        <div class="details">
                            <!--路径单独写-->
                            ...
                            <div class="bottom">
                                ...
                                <span class="num"
                                    ><i class="imv2-set-sns"></i> 2946</span
                                >
                            </div>
                        </div>
                    </a>
                    <a
                        href=""
                        target="_ blank"
                        title="从0打造微前端框架，实战汽车资讯平台，系统掌握微前端架构设计与落地能力"
                        class="recomment-item"
                    >
                        <div
                            class="img"
                            style="
                                background-image: url('/src/assets/60d44ec8084b799712000676-360-202.jpg');
                            "
                        ></div>
                        <div class="details">
                            <!--路径单独写-->
                            <div class="title-box">
                                <p class="title">
                                    <span class="text"
                                        >从0打造微前端框架，实战汽车资讯平台，系统掌握微前端架构设计与落地能力</span
                                    ><span class="tag shizhan">实战</span>
                                </p>
                            </div>
                            <div class="bottom">
                                ...
                                <span class="num"
                                    ><i class="imv2-set-sns"></i> 109</span
                                >
                            </div>
                        </div>
                    </a>
                    <a href="" target="_blank" title="" class="recomment-item">
                        <div
                            class="img"
                            style="
                                background-image: url('/src/assets/604f2bab0952610803240324-140-140.png');
                                background-size: 100%;
                            "
                        ></div>
                        <div class="details">
                ...
                <div class="inner-box">
                    ...
                    <div class="lore">
                        ...
                        <p class="lores clearfix">
                            ...
                            <a target="_ blank" href="">SpringBoot</a>
                            <a target="_blank" href="">Spring Cloud</a>
                            <a target="_ blank" href="">SSM</a>
                            <a target="_blank" href="">PHP</a>
                            <a target="_ blank" href="">.net</a>
                            <a target="_blank" href="">Python</a>
                            <a target="_ blank" href="">爬虫</a>
                            <a target="_blank" href="">Django</a>
                            <a target="_ blank" href="">Flask</a>
                            <a target="_blank" href="">Tornado</a>
                            <a target="_ blank" href="">Go</a>
                            <a target="_blank" href="">C</a>
                            <a target="_ blank" href="">C++</a>
                            <a target="_blank" href="">C#</a>
                            <a target="_ blank" href="">Ruby</a>
                        </p>
                    </div>
                </div>
                <div class="recomment clearfix">
                    ...
                    >
                        <div
                            class="img"
                            style="
                                background-image: url('/src/assets/60a777ef0942d7bf06960344.png');
                                background-size: 100%;
                            "
                        ></div>
                        <div class="details">
                            <div class="title-box">
                                <p class="title">
                                    <span class="text">Java工程师2021</span>
                                    <span class="tag tixi">体系</span>
                                </p>
                            </div>
                            <div class="bottom">
                                ...
                                &middot;
                                <span class="num"
                                    ><i class="imv2-set-sns"></i> 15052</span
                                >
                            </div>
                        </div>
                    </a>
                    ...
                    >
                        <div
                            class="img"
                            style="
                                background-image: url('/src/assets/60a77721093df37606960344.png');
                                background-size: 100%;
                            "
                        ></div>
                        <div class="details">
                            ...
                            <div class="bottom">
                                ...
                                &middot;
                                <span class="num"
                                    ><i class="imv2-set-sns"></i> 10786</span
                                >
                            </div>
                        </div>
                    </a>
                    ...
                    >
                        <div
                            class="img"
                            style="
                                background-image: url('/src/assets/5dd6567b09d9d01c06000338.png');
                                background-size: 100%;
                            "
                        ></div>
                        <div class="details">
                            ...
                            <div class="title-box">
                                <p class="title">
                                    <span class="text">Java全栈工程师</span>
                                    <span class="tag tixi">体系</span>
                                </p>
                            </div>
                            <div class="bottom">
                                ...
                                <span class="num"
                                    ><i class="imv2-set-sns"></i> 1853</span
                                >
                            </div>
                        </div>
                    </a>
                    <a href="" target="_ blank" title="" class="recomment-item">
                        <div
                            class="img"
                            style="
                                background-image: url('/src/assets/604f2bb6099d6a8803240324-140-140.png');
                                background-size: 100%;
                            "
                        ></div>
                        <div class="details">
                ...
                <div class="recomment clearfix">
                    ...
                    >
                        <div
                            class="img"
                            style="
                                background-image: url('/src/assets/5ec5ddf209cd2c8606000338.png');
                                background-size: 100%;
                            "
                        ></div>
                        <div class="details">
                            ...
                            <div class="bottom">
                                ...
                                <span class="difficulty"> 进阶 </span> &middot;
                                <span class="num"
                                    ><i class="imv2-set-sns"></i> 402</span
                                >
                            </div>
                        </div>
                    </a>
                    <a
                        href=""
                        target="_blank"
                        title="Flutter高级进阶实战  仿哔哩哔哩APP 一次性深度掌握Flutter高阶技能"
                        class="recomment-item"
                    >
                        <div
                            class="img"
                            style="
                                background-image: url('/src/assets/60497caf0971842912000676-360-202.png');
                                background-size: 100%;
                            "
                        ></div>
                        <div class="details">
                            ...
                            <div class="bottom">
                                ...
                                <span class="difficulty"> 高级 </span> &middot;
                                <span class="num"
                                    ><i class="imv2-set-sns"></i> 646</span
                                >
                            </div>
                        </div>
                    </a>
                    <a
                        href=""
                        target="_ blank"
                        title="音视频基础+ffmpeg原理+项目实战 一课完成音视频技术开发入门"
                        class="recomment-item"
                    >
                        <div
                            class="img"
                            style="
                                background-image: url('/src/assets/5e5621d0092c054612000676-360-202.png');
                                background-size: 100%;
                            "
                        ></div>
                        <div class="details">
                            ...
                            <div class="bottom">
                                ...
                                <span class="num"
                                    ><i class="imv2-set-sns"></i> 1303</span
                                >
                            </div>
                        </div>
                    </a>
                    <a href="" target="_blank" title="" class="recomment-item">
                        <div
                            class="img"
                            style="
                                background-image: url('/src/assets/604f2b52090de67603240324-140-140.png');
                                background-size: 100%;
                            "
                        ></div>
                        <div class="details">
            ...
            <div class="menuContent">
                <div
                    ...
                    @mouseover="state.current_menu = 0"
                >
                ...
                <div
                    class="item"
                    :class="{ 'js-menu-item-on': state.current_menu == 1 }"
                    @mouseover="state.current_menu = 1"
                >
                ...
                <div
                    class="item"
                    :class="{ 'js-menu-item-on': state.current_menu == 2 }"
                    @mouseover="state.current_menu = 2"
                >
            ...
            <div class="g-banner-content" @mouseover="state.current_menu = -1">
                <el-carousel
                    ...
                    arrow="always"
                    height="482px"
                    v-if="banner.banner_list[0]"
                >
                    <el-carousel-item
                        v-for="bannerItem in banner.banner_list"
                        :key="bannerItem.id"
                    >
                        <a :href="bannerItem.link" v-if="bannerItem.is_http">
                            <img
                        ...
                        <router-link :to="bannerItem.link" v-else
                            ><img
                                :src="bannerItem.image"
                                alt=""
                                style="width: 100%; height: 100%"
...
.g-banner .banner-anchor {
    ...
    width: 48px;
    height: 48px;
    background: rgba(28, 31, 33, 0.1) url(/src/assets/icon-left-small.png)
